                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-warning btn-sm text-white"
                                    ...
                                    data-coreui-target="#editData_<?= $barang['id_barang']; ?>">
                                    <i class="fas fa-edit"></i>&nbsp;Ubah
                                </button>
                                <!-- Akhir Tombol Edit -->

                                <!-- Modal Edit -->
                                <div class="modal fade" id="editData_<?= $barang['id_barang'] ?>"
                                    data-coreui-backdrop="static" data-coreui-keyboard="false" tabindex="-1"
                                    aria-labelledby="editModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editModalLabel">Form Ubah barang
                                                    <?= $barang['nama_barang']; ?></h5>
                                                <button type="button" class="btn-close" data-coreui-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <form action="<?= base_url('barang/edit/'.$barang['id_barang']); ?>"
                                                method="post">
                                                <?php csrf_field(); ?>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="mb-2">
                                                        ...
                                                        <input type="number" class="form-control" name="harga_barang"
                                                            id="hargaBarang" value="<?= $barang['harga_barang'] ?>">
                                                    </div>
                                                </div>
                                ...
                                <button type="button" class="btn btn-danger btn-sm text-white"
                                    data-coreui-toggle="modal"
                                    data-coreui-target="#hapusData_<?= $barang['id_barang']; ?>">
                                    <i class="fas fa-trash"></i>&nbsp;Hapus
                                </button>
                                <!-- Akhir Tombol Hapus -->

                                <!-- Modal hapus -->
                                <div class="modal fade" id="hapusData_<?= $barang['id_barang'] ?>"
                                    data-coreui-backdrop="static" data-coreui-keyboard="false" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                <form action="<?= base_url('barang/delete/'.$barang['id_barang']); ?>"
                                                    method="post">
                                                    <?php csrf_field(); ?>
