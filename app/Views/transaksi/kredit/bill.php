...
<body>
    <nav class="bg-dark mb-3 no-print">
        <div class="container d-flex justify-content-between py-1">
            <a href="<?= base_url('transaksi-kredit'); ?>" class="btn btn-sm btn-danger text-white"><i
                ...
                <div class="col">
                    <table class="table table-bordered">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                <td colspan="4" class="text-center">Nominal Pembayaran DP</td>
                                <td><?= rupiah($header['total_transaksi'] - $header['piutang_transaksi']); ?></td>
                            </tr>
                            <tr>
                                <td colspan="4" class="text-center">Nominal Piutang</td>
                                <td><?= rupiah($header['piutang_transaksi']); ?></td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
