    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="mb-2">
            ...
            <select name="id_barang" id="namaBarang" class="form-select" onchange="cekSubtotal()">
        ...
        <div class="mb-2">
          ...
          <input type="number" class="form-control" name="quantity_barang" id="quantityBarang" onkeyup="cekSubtotal()" onchange="cekSubtotal()">
