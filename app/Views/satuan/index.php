                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="editModalLabel">Form Ubah Satuan
                                                    <?= $satuan['nama']; ?></h5>
                                                <button type="button" class="btn-close" data-coreui-dismiss="modal"
                                                    aria-label="Close"></button>
                                            </div>
                                            <form action="<?= route_to('satuan.update',$satuan['id']); ?>"
                                                method="post">
                                                <?php csrf_field(); ?>
                                                <input type="hidden" name="_method" value="PUT">
                                                <div class="modal-body">
                                                    <div class="mb-2">
                                                        <label for="namaSatuanEdit" clask s="form-label">Nama
                                                            satuan</label>
                                                        <input type="text" class="form-control" name="nama"
                                                            id="namaSatuanEdit" value="<?= $satuan['nama']; ?>">
                                                    </div>
                                                </div>
                                ...
                                <!-- Modal hapus -->
                                <div class="modal fade" id="hapusData_<?= $satuan['id'] ?>"
                                    data-coreui-backdrop="static" data-coreui-keyboard="false" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Apakah anda yakin akan menghapus data <?= $satuan['nama']; ?>
                                            </div>
                                            <div class="modal-footer">
                                                <form action="<?= route_to('satuan.delete', $satuan['id']) ?>"
                                                    method="post">
                                                    <?php csrf_field(); ?>
